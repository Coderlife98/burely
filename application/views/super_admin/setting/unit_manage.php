...
<div class="card">
	 <div class="col-12 mitbl">
		<i class="bx bx-crown miU"></i> Search Unit Details
		<span><a  href="javascript:void(0)"id="addUnitDetails" class="miGrtitle" title="Add New"><i class="bx bx-plus"></i></a></span>
     </div>
	<div class="card-body">
	<form method="post" id="search_Unit">
		 <div id="setResultMsg" class="ami_warning" style="display:none;">&nbsp;</div>
		<div class="col-xl-12">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-floating mb-3">
						<input type="text" name="unit_nm" id="unit_nm" value="" class="form-control">
						<label for="designation"><i class="bx bxs-crown fntClr"></i> Unit Name </label>
					</div>
				</div>
				<div class="col-lg-6">
						<div class="form-floating mb-3">
		  ...
		  <button type="submit" class="btn cstm_btn pull-right" onclick="return get_search(repUnitManage,'#search_Unit','#tbl_unit_manage')">
...
<div class="card">
	...
	<div class="table-responsive">
		<div id="search_data">  
		<table class="table align-middle table-striped table-nowrap mb-0" id="tbl_unit_manage">
		<thead class="hdr_clr">
			<tr>
				<th>S.No</th>
				<th>Unit Id</th>
...
<div class="modal fade" id="manage_unit" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
							...
							<div class="col-lg-12"><div id="getMsgSuccess" style="display:none;">&nbsp;</div></div>	
							 	<div class="col-lg-12">
									<div class="form-floating mb-3">
										...
										<label for="unit_name"><i class="bx bxs-crown fntClr"></i> Unit Name <span class="text-danger">*</span></label>
									</div>
								</div>  
						<?php if($this->lgCat=='1'){?>	
					...
					<div class="modal-footer">
						...
						<button class="btn btn-outline-primary ActnCmdByAmi" id="proceedUnit"><i class="bx bx-save"></i> Update</button>
					</div>
				</div>
			</div>
	</div>
