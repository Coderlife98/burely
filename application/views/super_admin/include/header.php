<?php if($this->session->userdata('user_cate')=='2'){$usrPic=base_url().$this->session->userdata('photo');}
else{$usrPic=base_url() . '/' . $this->session->userdata('photo');}?>
<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            <!-- LOGO -->
            <div class="navbar-brand-box">
                <a href="<?php echo base_url('super_admin/dashboard');?>" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="<?php echo base_url('super_admin/dashboard');?>" class="logo logo-light">
                    <span class="logo-sm">
...
<!--/*-21px 0px 0px 0px*/-->
            ...
            <div class="dropdown d-inline-block">
                ...
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="<?php echo $usrPic; ?>" alt="Header Avatar">
...
<?php }else{ ?>					
	 <a class="dropdown-item" href="<?php echo base_url() . 'mlm_software/admin/employee/view/'.urlencode(base64_encode($this->session->userdata('user_id'))); ?>"><i class="mdi mdi-account-circle text-muted font-size-16 align-middle me-1"></i> <span class="align-middle" key="t-profile">Profile</span></a>				
<?php }?>					
