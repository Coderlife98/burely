...
<form method="post" id="search_manage">
	<div class="col-xl-12">
		<div class="card">
...
<div class="card">
    <div class="card-body">	
		...
		<div id="search_data">  
		<table id="manage_table" class="table align-middle table-striped table-nowrap mb-0">
...
<!----------------------------Model bx strt----------------------------->
<div id="actnU" style="display:none;"><?php echo $actn_url?></div>
