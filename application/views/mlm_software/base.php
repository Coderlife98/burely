                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <p class="text-muted text-uppercase fw-semibold font-size-13">All Users</p>
                                            <h4 class="mb-1 mt-1"><span class="counter-value" data-target="<?php echo $all_user;?>">0</span></h4>
                                        </div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mt-4 mt-sm-0">
                                                    <img src="<?php echo base_url() ?>media/images/widget-img.png" class="img-fluid" alt="widget-img">
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!-- end card-body-->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="float-end">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-reset" href="#" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-striped table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-2.jpg" alt="user-image" class="avatar-xs rounded-circle me-2">
                                                            Herbert C. Patton
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-3.jpg" alt="user-image" class="avatar-xs rounded-circle me-2">
                                                            Mathias N. Klausen
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-4.jpg" alt="user-image" class="avatar-xs rounded-circle me-2">
                                                            Nikolaj S. Henriksen
                                                        </td>
                                                        <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-5.jpg" alt="user-image" class="avatar-xs rounded-circle me-2">
                                                            Lasse C. Overgaard
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-6.jpg" alt="user-image" class="avatar-xs rounded-circle me-2">
                                                            Kasper S. Jessen
                                                        </td>
                                                        <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm
                                                        </td>
                                            ...
                                            <table class="table align-middle table-striped table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>#12354781</td>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/products/img-1.png" alt="user-image" style="height: 32px;" class="rounded me-2">
                                                    ...
                                                    <tr>
                                                        <td>#52140300</td>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/products/img-2.png" alt="user-image" style="height: 32px;" class="rounded me-2">
                                                    ...
                                                    <tr>
                                                        <td>#96254137</td>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/products/img-3.png" alt="user-image" style="height: 32px;" class="rounded me-2">
                                                    ...
                                                    <tr>
                                                        <td>#12365474</td>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/products/img-4.png" alt="user-image" style="height: 32px;" class="rounded me-2">
                                                    ...
                                                    <tr>
                                                        <td>#85214796</td>
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/products/img-5.png" alt="user-image" style="height: 32px;" class="rounded me-2">
                                                            BeoPlay Speaker
                                                        </td>
                                            ...
                                            <table class="table table-hover table-borderless align-middle table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-1.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-2.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-3.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-4.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo base_url() ?>media/images/users/avatar-5.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
