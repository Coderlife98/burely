			...
			<div class="mt-4">
				<ul class="nav nav-tabs nav-tabs-custom" role="tablist" style="margin-top: -25px;padding: 10px 0px 0px 10px;">
					<li class="nav-item" role="presentation">
						<a class="nav-link profile" data-bs-toggle="tab" href="#profile_det" role="tab" aria-selected="true">
					...
					<li class="nav-item" role="presentation">
						<a class="nav-link business" data-bs-toggle="tab" href="#payroll_det" role="tab" aria-selected="false" tabindex="-1">
					...
					<li class="nav-item" role="presentation">
						<a class="nav-link orders active" data-bs-toggle="tab" href="#orders_det" role="tab" aria-selected="false" tabindex="-1">
							<span class="d-block d-sm-none"><i class="bx bx-money"></i></span>
				...
				<div class="tab-content p-3 text-muted">
					<div class="tab-pane " id="profile_det" role="tabpanel">
						...
						<div class="card-body p-4">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control">
											<?php if ($getDetails->date_of_birth) {
												echo date('d-M-Y', strtotime($getDetails->date_of_birth));
											} else {
												echo 'N/A';
											} ?>
										</span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->mobile) {
																		echo $getDetails->mobile;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3"><span class="form-control"><?php if ($getDetails->email) {
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->aadhaar_nu) {
																		echo $getDetails->aadhaar_nu;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->pan_no) {
																		echo $getDetails->pan_nu;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-12">
									<div class="form-floating mb-3">
										<span class="form-control" style="height:85px;"><?php if ($getDetails->address) {
																							echo $getDetails->address;
																						} else {
																							echo 'N/A';
																						} ?></span>
								...
								<div class="col-lg-4">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->zipcode) {
																		echo $getDetails->zipcode;
																	} else {
																		echo 'N/A';
																	} ?></span>
						...
						<div class="card-body p-4">
							<div class="row cardBtm">
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->bank_name) {
																		echo $getDetails->bank_name;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->bank_ac_no) {
																		echo $getDetails->bank_ac_no;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->bank_Ifsc) {
																		echo $getDetails->bank_Ifsc;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->bankBrName) {
																		echo $getDetails->bankBrName;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->btc_address) {
																		echo $getDetails->btc_address;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->nominee_name) {
																		echo $getDetails->nominee_name;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->nominee_address) {
																		echo $getDetails->nominee_address;
																	} else {
																		echo 'N/A';
																	} ?></span>
								...
								<div class="col-lg-6">
									<div class="form-floating mb-3">
										<span class="form-control"><?php if ($getDetails->nominee_relationship) {
																		echo $getDetails->nominee_relationship;
																	} else {
																		echo 'N/A';
																	} ?></span>
					...
					<div class="tab-pane" id="payroll_det" role="tabpanel">
						...
						<div class="row" style="margin-top:20px;">
							...
							<div class="table-responsive">
								<div id="search_data">
									<table class="table align-middle table-striped table-nowrap mb-0" id="my_sale_list">
					...
					<div class="tab-pane active" id="orders_det" role="tabpanel">

						<?php if (!empty($orders_det)) : foreach ($orders_det as $orders) : ?>
								<p style="border-bottom: 1px solid ">
									<a class="btn btn-primary" data-bs-toggle="collapse" href="#order<?php echo $orders['id']; ?>" role="button" aria-expanded="false" onclick="get_order_list(<?php echo $orders['id']; ?>)">#Order Invoice:<?php echo $orders['invoice_id'] ?>
									</a>
									<span style="float:right">Delivery Date:<?php echo $orders['delevery_date']; ?></span>

								</p>


								<div class="collapse multi-collapse hide" id="order<?php echo $orders['id']; ?>">
									<div class="card card-body mb-5">
										<!-- content started -->
										<div>
										<a style="float:left;">order status&nbsp;:&nbsp;
											<?php
										...
										<a href="javascript:void(0);" id="delete_order<?php echo $orders['id'];?>" onclick="delete_order(<?php echo $orders['id']; ?>)" data-order_id="<?php echo $orders['id']; ?>" style="float:right;" class="text-danger" title="cancel Order"><span class="fa fa-trash"></span></a>
										<?php endif;?>
										...
										<div class="row" style="margin-top:20px;">
											<div class="table-responsive1">
												<div id="search_data">
													<table class="table align-middle table-striped table-nowrap mb-0" id="order_list<?php echo $orders['id']; ?>" style="width:100%;">
														<thead class="amiCrdTitle">
															<tr>
																<th>S.No</th>
																<th>Items</th>
														...
														<tbody id="order_list_view<?php echo $orders['id']; ?>">
														</tbody>
														<tfoot>
														        <th></th>
																<th></th>
															...
															<th colspan="2" class="text-center">
																<?php echo "Paid Amount&nbsp;:&nbsp;" . $orders['paid_amt'] ?>
															</th>
														</tfoot>
													</table>
												</div>
							...
							<h3 class="text-danger text-center">Order Not Found</h3>
						<?php endif; ?>
...
<script src="<?php echo base_url() ?>media/js/mlm_software/admin//shopee/order_details.js"></script>