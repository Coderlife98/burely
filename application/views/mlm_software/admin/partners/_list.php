		...
		<div class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
					<div id="search_data">
						<table id="member_list" class="table table-striped table-hover text-nowrap">
							<thead class="hdr_clr">
								<tr>
									<th>S No.</th>
									<th><?php echo $memberTyp; ?> Id.</th>
									<th><?php echo $memberTyp; ?> Name.</th>
...
<input type="hidden" id="miTarget" value="<?php echo base_url('mlm_software/admin/partners/isCheck');?>">
