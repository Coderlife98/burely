        ...
        <div class="card">
            ...
            <div class="card-body">
                <div>
					...
					<div id="proPic">
                <img src="<?php echo $getImg; ?>" alt="<?php echo $getDetails['name']; ?>" class="avatar-xl img-thumbnail rounded-circle mb-3 mi_thumb">
					</div>	
...
<div ><p class="mb-1 text-muted font-size-13"><i class="bx bx-envelope "></i>  E-mail :</p> <h5 class="font-size-14"><?php echo $getDetails['email'] ?></h5></div>
    ...
    <div class="col-xl-8">
       <form id="member_profile_data" method="post">
	    	<?php 
						print_r($getDetails);
					$dob=date('Y-m-d',strtotime($getDetails['date_of_birth']));
		//	print_r($getDetails['shw_pass']);
			?>
			...
			<div class="card">
				<div class="card-header ami_cmn">
					...
					<a href="<?php echo base_url().'mlm_software/admin/partners/'.$memberTyp;?>" class="ititle miMr" title="Back to list"><i class="bx bx-arrow-back"></i></a>
				</div>
