...
<tbody>
	...
	$ctr=0;	$grandTotal=0;	
		...
		<tr>
			...
			<td> <?php echo number_format($netAMtAfterDiscount,2);?></td>
		...
		?>
		<tr><td colspan="8" style="text-align:right"><strong>Grand Total</strong> </td><td> <strong><?php echo number_format($grandTotal,2);?></strong></td></tr>
	<tr><td colspan="8" style="text-align:right"><strong>Paid Amt</strong> </td><td> <strong><?php echo number_format($ordHistory['paid_amt'],2);?></strong></td></tr>	
	<tr><td colspan="8" style="text-align:right"><strong>Dues Amt</strong> </td><td> <strong><?php echo number_format($duesAmt,2);?></strong></td></tr>							
<?php }else{?>
	<tr>
		<td colspan="9" align="center"><code>Ooop's there is no data found</code><br />
