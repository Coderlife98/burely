						...
						<tbody>
							...
							$ctr=0;	$grandTotal=0;	
								...
								<tr>
									...
									<td><?php echo $dList['productTax'];?> <i class="mdi mdi-percent-outline inrP"></i></td>
									<td><i class="bx bx-rupee inrP"></i> <?php echo number_format($netAmt,2);?></td>
								</tr>
								<?php $grandTotal+=$netAmt;} $paybleAmt=$grandTotal;?>
...
<a href="<?php echo base_url('mlm_software/admin/sale/get_preview/'.urlencode(base64_encode($invId)));?>" class="btn btn-outline-primary waves-effect waves-light" style="float:right;" target="_blank"><i class="bx bx-printer"></i> Print</a>
			<a href="<?php echo base_url('mlm_software/admin/sale');?>" class="btn btn-outline-dark waves-effect waves-light"><i class="bx bx-arrow-back"></i> Back</a>
		 </div>
	</div>	
	</div>
</div>
