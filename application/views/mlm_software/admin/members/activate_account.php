...
<div class="col-xl-12">
	<div class="card">
		...
		<div class="miArv">
			<i class="bx bxs-group miAr"></i>Buy Package
			<span><a href="<?php echo base_url('mlm_software/admin/member'); ?>" class="miArvBack"><i class="bx bx-arrow-back"></i></a></span>
		</div>
		<div class="card-body p-4" style="margin-bottom:-10px;"><?php //print_r($this->session->userdata); 
				...
				<div class="col-lg-6">
					<div class="form-floating mb-3">
						<select class="form-select empSelectR" name="pack_plan" id="pack_plan">
							...
							<?php if ($pack_plan) {
								foreach ($pack_plan as $plan) { ?>
									<option value="<?php echo $plan['id']; ?>"><?php echo $plan['pack_price']; ?></option>
							<?php 	}
							} ?>
						</select>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="pyro" id="miFire" style="display:none;">
					...
					<div id="dGather" style="height:330px; border: 1px solid #f7f7f7;padding: 10px; display:none;">
						<table class="table table-bordered table-striped" style="width:60%; margin-top:15px;" align="center">
							<thead class="hdr_clr" style="border:1px solid #914b00;">
								<tr>
									<th colspan="2" style="font-weight:bold"><i class="bx bxs-shopping-bag-alt miAr"></i> MEMBER'S DETAILS</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td style="width:40%">Member Id <i class="mdi mdi-counter fntClr" style="float:right"></i></td>
									<td id="mId" class="fntbold">&nbsp;</td>
								</tr>
								<tr>
									<td>Member Name <i class="mdi mdi-account-circle-outline fntClr" style="float:right"></i></td>
									<td id="mname" class="fntbold">&nbsp;</td>
								</tr>
								<tr>
									<td>Mobile Number <i class="bx bxl-whatsapp  fntClr" style="float:right"></i></td>
									<td id="mobile" class="fntbold">&nbsp;</td>
								</tr>
								<tr>
									<td>Member Email <i class="bx bx-envelope fntClr" style="float:right"></i></td>
									<td id="eml" class="fntbold">&nbsp;</td>
								</tr>
								<tr>
									<td>Package Price <i class="mdi mdi-currency-inr fntClr" style="float:right"></i></td>
									<td id="packPr" class="fntbold">&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div class="card-footer">
			<a href="<?php echo base_url('mlm_software/admin/member'); ?>" class="btn btn-outline-dark waves-effect waves-light"><i class="bx bx-arrow-back"></i> Back</a>
