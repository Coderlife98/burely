	...
	<div class="col-xl-12">
	   <div class="card">
		   <div class="card-title amiCrdTitle">
					...
					<a href="<?php echo base_url('partner/package');?>" class="pull-right"><i class="bx bx-arrow-back"></i></a>
		   </div>		
...
<!--<a href="<?php //echo base_url('mlm_software/admin/sale/get_preview/'.urlencode(base64_encode($invId)));?>" class="btn btn-outline-primary waves-effect waves-light" style="float:right;" target="_blank"><i class="bx bx-printer"></i> Print</a>-->
			<a href="<?php echo base_url('partner/package');?>" class="btn btn-outline-dark waves-effect waves-light"><i class="bx bx-arrow-back"></i> Back</a>
		 </div>
	</div>	
	</div>
</div>
