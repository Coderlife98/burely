	...
	<div class="col-xl-12">
	   <div class="card">
			...
			<div class="card-body p-4" style="margin-bottom:30px;">
				<div class="row">
				 ...
				 // 	print_r($ordHistory);
					...
					{*/
					 ?>
						<span id="getTargetForFrenchise">partner/sale/approved</span>
						<div class="col-md-6">	
						...
						<tbody>
							...
							$ctr=0;	$grandTotal=0;	
								...
								<tr>
									...
									<td colspan="7" style="text-align:right"><strong>Grand Total</strong> </td><td><i class="bx bx-rupee inrP"></i> <strong><?php echo number_format($grandTotal,2);?></strong></td>
								</tr>
								
								
								<tr>
									<td colspan="7" style="text-align:right"><strong>Tax</strong> </td><td><i class="bx bx-rupee inrP"></i> <strong><?php echo number_format($ordHistory['tax'],2);?></strong></td>
								</tr>
								<tr>
									...
									<td colspan="4" style="text-align:right"><strong>Shipping Charges</strong> </td><td><i class="bx bx-rupee inrP"></i> <strong><?php echo number_format($ordHistory['shipping_charge'],2);?></strong></td>
								</tr>
								<tr>
									...
									<td><strong>
												<?php 
														...
														?></strong></td>
									<td colspan="4" style="text-align:right"><strong>Payble Amount</strong> </td><td><i class="bx bx-rupee inrP"></i> <strong><?php echo number_format($paybleAmt,2);?></strong></td>
								</tr>
								<tr> 
									...
									<td colspan="4" style="text-align:right"><strong>Paid Amt</strong> </td><td><i class="bx bx-rupee inrP"></i> <strong><?php echo number_format($ordHistory['paid_amt'],2);?></strong></td>
								</tr>
				...
				<?php if ($ordHistory['order_status']!='3'){?>	
								<tr> 
									...
									<td colspan="7" style="text-align:right"><strong>Order Status</strong></td>
								...
								<?php }}else{?>
								<tr><td colspan="8" align="center"><code>Ooop's there is no data found</code><br />
		 ...
		 <div class="card-footer">		
          <?php if ($ordHistory['order_status']!='3'){?>	 
		     <button type="button" class="btn btn-outline-success waves-effect waves-light memAction" style="float:right; margin-left:10px;" id="saleCnfrmByFrenchise">
