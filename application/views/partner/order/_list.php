 ...
 <div class="row mb-4">
	<div class="col-xl-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" id="search_order_list">
					<div class="col-xl-12">
						<div class="row">
							<div class="col-lg-6">
								<div class="form-floating mb-3">
									<input type="text" name="orderId" id="orderId" class="form-control" >
									<label for="userId"><i class="bx bx-transfer fntClr"></i> Order Id</label>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="form-floating mb-3">
										<select class="form-select" name="actnType" id="actnType">
											...
											<option value="undelevered">Undelevered</option>
						...
						<button type="submit" class="btn btn-outline-primary waves-effect waves-light pull-right" onclick="return get_search(reportOrdTable,'#search_order_list','#my_order_list')"><i class="mdi mdi-account-search"></i> Search </button>
					</div>
				</form>
			</div>
		</div>
		<div class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
					<div id="search_data">
						<table id="my_order_list" class="table table-striped table-hover">
							<thead class="hdr_clr">
								<tr>
									<th>S No.</th>
									<th>Order Id.</th>
