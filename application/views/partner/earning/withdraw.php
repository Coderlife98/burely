...
<div class="row mb-4">
	<div class="col-xl-12">
		<div class="card-title amiCrdTitle">
			<i class="bx bx-wallet-alt"></i> <?php echo $breadcrums ?> 
		...
		<div class="col-md-4">
			<div class="card-type-pricing text-center">
				<div class="card-body style-custom">
					<h2 class="rewardN"><?php echo $usrDetails->name;?></h2>
					<div class="price">
						<img src="<?php echo base_url('uploads/member/no_profile.png');//$usrDetails->my_img?>" alt="<?php echo $usrDetails->name;?>" class="avatar-lg rounded-circle mb-3">
					</div>
					<!--<p class="amiWallet"><em>Position<?php //echo $usrDetails->rank;?></em></p>-->
				</div>
		...
		<div class="tab-pane active" id="earnedInc" role="tabpanel">
			<p class="mb-0">
				...
				<form class="form" role="form">	
					...
					<button class="btn btn-outline-dark waves-effect waves-light pull-right actionCmd" id="amiWthDrw" type="button"><i class="fa fa-check"></i> Withdraw</button>
				</form>	
			</p>
		</div>
