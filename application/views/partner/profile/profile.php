...
<?php
if($member->my_img){if($member->my_img!='uploads/user/no_img.png'){$getImg=$this->baseUrl.$member->my_img;}
else{$getImg=$this->baseUrl.'uploads/user/no_partner.png';}}else{$getImg=$this->baseUrl.'uploads/user/no_partner.png';}
if($member->status=='Active'){$statusClr='#049504';$backClr='background-color:rgba(179, 227, 179, 0.4)';}
elseif($member->status=='Block'){$statusClr='#970000';$backClr='background-color:rgba(176, 137, 137,0.4)';}
if($member->status=='Suspend'){$statusClr='#bd7b02';$backClr='background-color:rgba(215, 192, 151,0.4)';}
			...
			<div class="row">
				 ...
				 <div class="col-md-6">
						<div class="amiprD"><i class="bx bx-calendar"></i>
							...
							<span class="joinM"><?php if($member->create_date){ echo date('d-M-Y',strtotime($member->create_date));}else{ echo 'N/A';}?></span>
						</div>
					</div>
			</div>
		</div>
				...
				<div class="row">	
					<div class="col-md-4">
						...
						<div class="docText"> Aadhaar Card
							<span><i class="bx bx-trash delAction" data-bs-toggle="modal" data-bs-target="#deleteModel" data-id="delAadhar-partner/profile/edit"></i>
								  <i class="bx bx-image delAction" data-id="midoc-edtAadhar-partner/profile/edit"></i>
							</span>
						</div>
					</div>
					<div class="col-md-4">
						...
						<div class="docText"> Pan Card
							<span><i class="bx bx-trash delAction" data-bs-toggle="modal" data-bs-target="#deleteModel" data-id="delPan-partner/profile/edit"></i>
								  <i class="bx bx-image delAction" data-id="midoc-pancard-partner/profile/edit"></i>
							</span>
						</div>
					</div>
					<div class="col-md-4">
						...
						<div class="docText"> Bankpass Book
							<span>
							    <i class="bx bx-trash delAction" data-bs-toggle="modal" data-bs-target="#deleteModel" data-id="delBankpass-partner/profile/edit"></i>	
								<i class="bx bx-image delAction" data-id="midoc-passbook-partner/profile/edit"></i>
						</span>
						</div>
					</div>
				</div>		
