...
<div class="row">
 ...
 <div class="row mb-4">
	<div class="col-xl-12">
		...
		?>	
		<div class="ami_title">
		<i class="bx bx-user-circle miU"></i> Downline List
		<span><a href="<?php echo base_url('member/subscriber/view');?>" class="miBack"><i class="bx bx-arrow-back"></i></a></span>
								...
								<td colspan="3">
									<div class="infoContainer">
										<table width="100%">
										  ...
										  <tr>
												<td width="17%"><span class="mnBldTxt">Name of Member</span></td>
...
$(document).ready(function(){
	...
	getBxWithTxt('<?php echo $getPro->sponsorName;?>',20,'sponsorName');
	getBxWithTxt('<?php echo $getPro->sponsor;?>',9,'sponsorId');
...
.shopeInf{text-transform:uppercase; font-weight:900;border-bottom: 2px solid #02738c; color:#02738c;font-size: 20px;}
...
.spInfo{padding:5px 15px 5px 15px;background-color: #02738c;float: left;font-weight: bold;color: #fff;z-index: 1;position: relative;margin: -2px 0px 5px -2px;}
.infoContainer{padding:0px 0px 15px 0px;border: 2px solid #02738c;margin: 15px 0px 0px 0px;}
...
.sprInfo{padding:0px 0px 15px 0px;border: 2px solid #02738c;}
...
.miBdrCnr {border: 1px solid #02738c;display: inline-block;/*margin: 25px auto;*/padding:25px 10px 25px 10px;position: relative;width: auto;}
