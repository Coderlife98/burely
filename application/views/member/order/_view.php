				 ...
				 // 	print_r($ordHistory);
					...
					{*/
					 ?>
								...
								<i class="bx bxl-product-hunt"></i> Seller Details
									...
									<table width="100%">
									  ...
									  <td width="22%" rowspan="5">
										...
										<td width="52%" class="fbold" id="slrCode"><?php echo 'S'.$getFrenchise->username;?></td>
									  </tr>
											<tr>
								...
								<div class="slr_title">
									...
									<table width="100%">
									  ...
									  <td width="22%" rowspan="5">
										  ...
										  <td width="26%"  class="fright">Provider Code :</td>
										<td width="52%" class="fbold" id="slrCode"><?php echo 'MSD'.$getBuyer->username;?></td>
						...
						?>
					<table class="table table-bordered table-striped  text-nowrap" align="center" >
						<thead class="hdr_clr" style="border:1px solid #0576b9;">
							<tr >
								<th>S No.</th>
								<th>Product Name</th>
								<th style="text-align:center">Quantity</th>
								<th style="text-align:center">P. BV</th>
								<th>MRP</th>
								<th>Sell Price</th>
						...
						<tbody>
							...
							$ctr=0;	$grandTotal=0;	
								...
								<tr>
									...
									<td style="text-align:center"><?php echo $dList['product_qty'];?></td>
									<td style="text-align:center"><?php echo $dList['productBv'];?></td>
								...
								<tr>
									...
									<td><strong>
												<?php 
														...
														?></strong></td>
									<td colspan="5" style="text-align:right"><strong>Paid Amt</strong></td>
								...
								<tr> 
									...
									<td colspan="5" style="text-align:right"><strong>Dues Amt</strong> </td><td><i class="bx bx-rupee inrP"></i> <strong><?php echo number_format($duesAmt,2);?></strong></td>
								</tr>
								<?php }else{?>
...
<a href="<?php echo base_url('member/order/get_preview/'.urlencode(base64_encode($invId)));?>" class="btn btn-outline-primary waves-effect waves-light" style="float:right;" target="_blank"><i class="bx bx-printer"></i> Print</a>
			<a href="<?php echo base_url('member/order');?>" class="btn btn-outline-dark waves-effect waves-light"><i class="bx bx-arrow-back"></i> Back</a>
		 </div>
	</div>	
	</div>
</div>
