	...
	<div class="col-xl-12">
	   <div class="card">
		   <div class="card-title amiCrdTitle">
				...
				<a href="<?php echo base_url('member/order/add_kart');?>" class="pull-right"><i class="bx bx-arrow-back"></i></a>
		   </div>
							...
							<tbody>
								...
								$ctr=0;	$grandTotal=0;	
									...
									<tr>
										...
										<td><?php echo $dList['product_qty'];?></td><td><?php echo $dList['productBV']*$dList['product_qty'];?></td>
									...
									<?php $grandTotal+=$netAmt; $soldBy=$dList['soldBy'];$seller_id=$dList['seller_id'];} $paybleAmt=$grandTotal;?>
									<tr>
					            ...
					            $saleID=urlencode(base64_encode($ordID.'@@@@@'.$grandTotal.'@@@@@'.$adminCharge->shipping_charges.'@@@@@'.$adminCharge->tax.'@@@@@'.$provider['slrID'].'@@@@@'.$provider['sellerType']));
								?>	
							</tbody>
						</table>
...
<input type="hidden" id="target" value="<?php echo base_url('member/order/payment_success'); ?>">
