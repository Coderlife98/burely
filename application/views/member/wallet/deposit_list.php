				...
				<div class="col-md-12">
					<form method="post" id="search_depo_list">
						<div class="col-xl-12">
							...
							<a href="<?php echo base_url('member/dashboard'); ?>" class="btn btn-outline-dark  waves-effect waves-light"><i class="bx bx-arrow-back"></i> Back</a>
...
<div class="row mb-4">
	<div class="col-xl-12">
		<div class="ami_title"><i class="bx bx-detail  miU"></i> My Wallet Histroy List

			<span><a href="<?php echo base_url('member/dashboard'); ?>" class="miBack"><i class="bx bx-arrow-back"></i></a></span>
			<span><a href="javascript:void(0)" id="miSearch" class="miBack" style="margin-right:5px;"><i class="bx bx-search-alt"></i></a></span>
		</div>
		<div class="crdDet btm_border">
			<div class="row mi_padd">
				<div class="col-md-12">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="delMsg"><i class="fa fa-trash"></i> &nbsp;</div>
