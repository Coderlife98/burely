...
class Common extends CI_Controller
{
    public function __construct()
    {
        ...
        //($this->session->userdata('user_cate') != 1)? redirect(base_url(), 'refresh') : '';//$this->session->userdata('user_id') != '')
    ...
    public function cityList()
    {
	 ...
	 $getCity=$this->Common_model->getDataList('states_cities','parent_id',$id);
	 sleep(1);
