...
defined('BASEPATH') OR exit('Can we play bubu together ?');
    ...
    $config['mlm_leg'] = "1";    #Automatically mark registration products as Delivered ?
    
    #Enable/Disable Module
    $config['mlm_survey_module'] = "0";                    #Enable Survey ?
    $config['mlm_coupon_module'] = "0";                    #Enable Coupon ?
    ...
    $config['mlm_recharge_module'] = "0";                #Enable Rewards Module?
    $config['mlm_product_module'] = "0";                  #Enable Recharge Module ?
    $config['mlm_repurchase_module'] = "0";            #Enable Product & Services ?
    $config['mlm_advertisment_module'] = "0";         #Enable Repurchase System ?
?>